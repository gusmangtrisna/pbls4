            ...
            <div class="relative max-w-6xl">
                <div class="w-[700px] h-[620px] bg-white border rounded-[8px] px-16 mt-24 mb-2">
                    <div class="text-center my-12">
                        <p class="text-[#8C8C8C] font-semibold text-[16px]">Dapatkan Tiket Anda</p>
                        <h1 class="text-[32px] font-extrabold">TAMAN EDELWEIS BALI</h1>
                    </div>
                   <form action="/tiket" method="POST" class="mt-8">
                        <label class="text-[14px] font-bold text-start pb-4">Pilih Tiket : </label>
                        ...
                        <div class="flex justify-between items-center">
                            <div class="bg-white flex justify-between items-center w-[270px] h-[60px] border px-5">
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <label for="adult" class="font-bold text-[16px]">Dewasa</label>
                                </div>
                            ...
                            <div class="bg-white flex justify-between items-center w-[270px] h-[60px] border px-5">
                                <div class="flex items-start gap-3">
                                    <input type="checkbox" id="adult" name="pTicket[]" class="my-auto accent-green-600 w-5 h-5 rounded-lg">
                                    <label for="adult" class="font-bold text-[14px]">Anak-anak</label>
                                </div>
                                <div class="flex justify-between items-center gap-2">
                                    {{-- Button - --}}
                        ...
                        {{-- Nama --}}
                        <div class="mt-5">
                        <label for="nama" class="text-[14px] font-bold text-start">Nama : </label>
                        </div>
                        <input type="text" id="nama" class="pl-3 bg-white border w-[570px] h-[40px]" required>
                        {{-- Input Tanggal --}}
                        <div class="mt-5">
                            <label for="tanggal" class="text-[14px] font-bold text-start">Tanggal : </label>
                        </div>
                        ...
                        <div class="mt-10 text-center">
                            <button type="submit" class="w-[300px] h-[40px] bg-[#2C3930] text-[24px] rounded-lg font-bold text-white">Submit</button>
                            <p class="text-[#8C8C8C] font-semibold text-[14px]">Pastikan Proses Pembayaran Anda Aman</p>
                        </div>
                   </form>
                </div>
            </div>
